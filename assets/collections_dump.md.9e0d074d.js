import{_ as s,o as a,c as n,O as l}from"./chunks/framework.5035f75f.js";const C=JSON.parse('{"title":"dump","description":"","frontmatter":{},"headers":[],"relativePath":"collections/dump.md","filePath":"collections/dump.md","lastUpdated":1648089437000}'),p={name:"collections/dump.md"},o=l(`<h1 id="dump" tabindex="-1">dump <a class="header-anchor" href="#dump" aria-label="Permalink to &quot;dump&quot;">​</a></h1><p>打印集合的元素，在调试时很有帮助。</p><div class="language-php"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#82AAFF;">collect</span><span style="color:#89DDFF;">([</span><span style="color:#F78C6C;">1</span><span style="color:#89DDFF;">,</span><span style="color:#F78C6C;">2</span><span style="color:#89DDFF;">,</span><span style="color:#F78C6C;">3</span><span style="color:#89DDFF;">,</span><span style="color:#F78C6C;">4</span><span style="color:#89DDFF;">])</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">*/</span></span></code></pre></div><p>我们可以通过在链式调用集合方法的时候使用<code>dump</code>打印出当前的集合状态，以便查看集合状态。</p><p>如果需要在某处停止链式调用，建议使用 <a href="./dd.html">dd</a> 方法。</p>`,5),t=[o];function e(c,r,y,i,F,D){return a(),n("div",null,t)}const d=s(p,[["render",e]]);export{C as __pageData,d as default};
