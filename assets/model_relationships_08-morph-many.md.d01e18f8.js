import{_ as s,o as a,c as n,O as e}from"./chunks/framework.5035f75f.js";const m=JSON.parse('{"title":"多态一对多","description":"","frontmatter":{},"headers":[],"relativePath":"model/relationships/08-morph-many.md","filePath":"model/relationships/08-morph-many.md","lastUpdated":1642992318000}'),l={name:"model/relationships/08-morph-many.md"},p=e(`<h1 id="多态一对多" tabindex="-1">多态一对多 <a class="header-anchor" href="#多态一对多" aria-label="Permalink to &quot;多态一对多&quot;">​</a></h1><p>多态关联允许一个模型在单个关联下属于多个不同父模型。常见的多态关联就是评论，评论内容可能是属于文章或视频。</p><h2 id="软件版本" tabindex="-1">软件版本 <a class="header-anchor" href="#软件版本" aria-label="Permalink to &quot;软件版本&quot;">​</a></h2><ul><li><p>Laravel Version 5.4.19</p></li><li><p>PHP Version 7.0.8</p></li></ul><h2 id="关键字和表" tabindex="-1">关键字和表 <a class="header-anchor" href="#关键字和表" aria-label="Permalink to &quot;关键字和表&quot;">​</a></h2><ul><li><p><code>morphTo()</code></p></li><li><p><code>morphMany()</code></p></li><li><p><code>attach()</code></p></li><li><p><code>detach()</code></p></li><li><p><code>sync()</code></p></li><li><p><code>toggle()</code></p></li><li><p><code>posts</code> 、<code>videos</code>、<code>comments</code> 和 <code>users</code> 表</p></li></ul><p>常见的多态关联就是评论，现在我们的内容类型包括文章和视频，用户既可以评论文章 ，也可以评论视频 。文章存在文章表 <code>posts</code>，视频存在视频表 <code>videos</code> ，评论存在评论表 <code>comments</code> ，某一条评论可能归属于某篇文章，也可能归属于某个视频。 在评论表中添加一个 <code>commentable_id</code> 字段表示其归属节点 ID ，同时定义一个 <code>commentable_type</code> 字段表示其归属节点类型，比如 <code>App\\Post</code> 或者 <code>App\\Video</code> 。</p><h2 id="生成模型和迁移文件" tabindex="-1">生成模型和迁移文件 <a class="header-anchor" href="#生成模型和迁移文件" aria-label="Permalink to &quot;生成模型和迁移文件&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">php artisan make:model  Post -m</span></span>
<span class="line"><span style="color:#A6ACCD;">php artisan make:model Video -m</span></span>
<span class="line"><span style="color:#A6ACCD;">php artisan make:model Comment -m</span></span></code></pre></div><h3 id="编辑迁移文件" tabindex="-1">编辑迁移文件 <a class="header-anchor" href="#编辑迁移文件" aria-label="Permalink to &quot;编辑迁移文件&quot;">​</a></h3><p>文件 <code>&lt;project&gt;/database/migrate/*_create_users_table.php</code> 内容如下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Schema::create(&#39;users&#39; , function(Blueprint $table){</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><p>文件 <code>&lt;project&gt;/database/migrate/*_create_posts_table.php</code> 内容如下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Schema::create(&#39;posts&#39;, function (Blueprint $table) {</span></span>
<span class="line"><span style="color:#A6ACCD;">    $table-&gt;increments(&#39;id&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><p>文件 <code>&lt;project&gt;/database/migrate/*_create_videos_table.php</code> 内容如下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Schema::create(&#39;videos&#39; , function(Blueprint $table){</span></span>
<span class="line"><span style="color:#A6ACCD;">    $table-&gt;increments(&#39;id&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        -&gt;onUpdate(&#39;cascade&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">        -&gt;onDelete(&#39;cascade&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><p>文件 <code>&lt;project&gt;/database/migrate/*_create_comments_table.php</code> 内容如下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Schema::create(&#39;comments&#39; , function(Blueprint $table){</span></span>
<span class="line"><span style="color:#A6ACCD;">    $table-&gt;increments(&#39;id&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">    $table-&gt;unsignedInteger(&#39;user_id&#39;);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        -&gt;onDelete(&#39;cascade&#39;);</span></span>
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;">// 注意： 这里 \`commentable_id\` 和 \`commentable_type\`，字段前缀与模型的方法保持一些。比如这列使用 \`commentable_\` 那么定义的关联方法为 \`commentable()\`</span></span></code></pre></div><h3 id="运行-php-artisan-命令保存修改到数据库" tabindex="-1">运行 php artisan 命令保存修改到数据库 <a class="header-anchor" href="#运行-php-artisan-命令保存修改到数据库" aria-label="Permalink to &quot;运行 php artisan 命令保存修改到数据库&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">php artisan migrate</span></span></code></pre></div><blockquote><p>执行上面的命令后数据库将生成六张表，如下：</p><ul><li>migrations</li><li>password_resets</li><li>users</li><li>commons</li><li>posts</li><li>videos</li></ul></blockquote><h2 id="定义关联关系和修改模型的-fillable-属性" tabindex="-1">定义关联关系和修改模型的 fillable 属性 <a class="header-anchor" href="#定义关联关系和修改模型的-fillable-属性" aria-label="Permalink to &quot;定义关联关系和修改模型的 fillable 属性&quot;">​</a></h2><p>在 <code>User</code> 模型中的对应关系：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">public function comments()</span></span>
<span class="line"><span style="color:#A6ACCD;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">    /**</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>在 <code>Post</code> 模型中的对应关系：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">protected $fillable = [&#39;user_id&#39; , &#39;title&#39; , &#39;body&#39; , &#39;published_at&#39;];</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>在 <code>Video</code> 模型中的对应关系：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">protected $fillable = [&#39;user_id&#39; , &#39;title&#39; , &#39;description&#39; , &#39;content&#39; , &#39;status&#39;];</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">public function user()</span></span>
<span class="line"><span style="color:#A6ACCD;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">    /**</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>在 <code>Comment</code> 模型中的对应关系：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">protected $fillable = [&#39;user_id&#39; , &#39;body&#39;];</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="使用-tinker-填充测试数据" tabindex="-1">使用 tinker 填充测试数据 <a class="header-anchor" href="#使用-tinker-填充测试数据" aria-label="Permalink to &quot;使用 tinker 填充测试数据&quot;">​</a></h2><p>修改 <code>/databases/factories/ModelFactory.php</code>，修改关联数据。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">/** @var \\Illuminate\\Database\\Eloquent\\Factory $factory */</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    ];</span></span>
<span class="line"><span style="color:#A6ACCD;">});</span></span></code></pre></div><p>使用 tinker 命令</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">php artisan tinker</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">factory(Video::class,10)-&gt;create(); // 生成10条 videos 表的测试数据</span></span></code></pre></div><p>至此，上面的 <code>users</code> 、<code>posts</code> 和 <code>videos</code> 表数据都已填充完毕。</p><h2 id="关联操作" tabindex="-1">关联操作 <a class="header-anchor" href="#关联操作" aria-label="Permalink to &quot;关联操作&quot;">​</a></h2><h3 id="新增数据" tabindex="-1">新增数据 <a class="header-anchor" href="#新增数据" aria-label="Permalink to &quot;新增数据&quot;">​</a></h3><h4 id="添加一个文章评论" tabindex="-1">添加一个文章评论 <a class="header-anchor" href="#添加一个文章评论" aria-label="Permalink to &quot;添加一个文章评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$post = \\App\\Post::find(1);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$post-&gt;comments()-&gt;save($comment); // 新增的 \`comment\` 模型中 \`commentable_id\` 和 \`commentable_type\` 字段会被自动设定</span></span></code></pre></div><h4 id="添加多条文章评论" tabindex="-1">添加多条文章评论 <a class="header-anchor" href="#添加多条文章评论" aria-label="Permalink to &quot;添加多条文章评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$user_id = \\Auth::user()-&gt;id;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$post-&gt;comments()-&gt;saveMany($comments);</span></span></code></pre></div><h4 id="添加视频评论" tabindex="-1">添加视频评论 <a class="header-anchor" href="#添加视频评论" aria-label="Permalink to &quot;添加视频评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$user_id = \\Auth::user()-&gt;id;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$video-&gt;comments()-&gt;save($comment); //</span></span></code></pre></div><h4 id="添加多条视频评论" tabindex="-1">添加多条视频评论 <a class="header-anchor" href="#添加多条视频评论" aria-label="Permalink to &quot;添加多条视频评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$user_id = \\Auth::user()-&gt;id;</span></span>
<span class="line"><span style="color:#A6ACCD;">$comments = [</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$video-&gt;comments()-&gt;saveMany($comments);</span></span></code></pre></div><h3 id="查询数据" tabindex="-1">查询数据 <a class="header-anchor" href="#查询数据" aria-label="Permalink to &quot;查询数据&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 查询一篇文章下的评论和发布评论者</span></span>
...
<span class="line"><span style="color:#A6ACCD;">$commentable = \\App\\Comment::find(1)-&gt;commentable()-&gt;with(&#39;user&#39;)-&gt;first();</span></span></code></pre></div><h3 id="删除数据" tabindex="-1">删除数据 <a class="header-anchor" href="#删除数据" aria-label="Permalink to &quot;删除数据&quot;">​</a></h3><h4 id="删除一篇文章下的所有评论" tabindex="-1">删除一篇文章下的所有评论 <a class="header-anchor" href="#删除一篇文章下的所有评论" aria-label="Permalink to &quot;删除一篇文章下的所有评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$post = \\App\\Post::find(1);</span></span>
<span class="line"><span style="color:#A6ACCD;">$post-&gt;comments()-&gt;delete();</span></span></code></pre></div><h4 id="删除用户的所有评论" tabindex="-1">删除用户的所有评论 <a class="header-anchor" href="#删除用户的所有评论" aria-label="Permalink to &quot;删除用户的所有评论&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$user = \\App\\User::find(1);</span></span>
<span class="line"><span style="color:#A6ACCD;">$user-&gt;comments()-&gt;delete();</span></span></code></pre></div><h3 id="更新数据" tabindex="-1">更新数据 <a class="header-anchor" href="#更新数据" aria-label="Permalink to &quot;更新数据&quot;">​</a></h3>`,54),t=[p];function o(c,i,r,C,A,d){return a(),n("div",null,t)}const g=s(l,[["render",o]]);export{m as __pageData,g as default};
