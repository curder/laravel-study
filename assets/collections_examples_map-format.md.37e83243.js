import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aefb929a.js";const u=JSON.parse('{"title":"map 格式化数据","description":"","frontmatter":{},"headers":[],"relativePath":"collections/examples/map-format.md","filePath":"collections/examples/map-format.md","lastUpdated":1677233952000}'),p={name:"collections/examples/map-format.md"},o=l(`<h1 id="map-格式化数据" tabindex="-1">map 格式化数据 <a class="header-anchor" href="#map-格式化数据" aria-label="Permalink to &quot;map 格式化数据&quot;">​</a></h1><p>有如下结构数组</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">$gates </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> [</span></span>
