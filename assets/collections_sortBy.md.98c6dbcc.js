import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aefb929a.js";const q=JSON.parse('{"title":"sortBy","description":"","frontmatter":{},"headers":[],"relativePath":"collections/sortBy.md","filePath":"collections/sortBy.md","lastUpdated":1648089437000}'),p={name:"collections/sortBy.md"},o=l(`<h1 id="sortby" tabindex="-1">sortBy <a class="header-anchor" href="#sortby" aria-label="Permalink to &quot;sortBy&quot;">​</a></h1><p>以给定的键对集合进行正序排序。</p><p><code>sortBy</code> 方法默认是正序排序，即数值越小排序越靠前。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
