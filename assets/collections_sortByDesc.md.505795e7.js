import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aefb929a.js";const q=JSON.parse('{"title":"sortByDesc","description":"","frontmatter":{},"headers":[],"relativePath":"collections/sortByDesc.md","filePath":"collections/sortByDesc.md","lastUpdated":1648089437000}'),p={name:"collections/sortByDesc.md"},o=l(`<h1 id="sortbydesc" tabindex="-1">sortByDesc <a class="header-anchor" href="#sortbydesc" aria-label="Permalink to &quot;sortByDesc&quot;">​</a></h1><p>以给定的键对集合进行正序排序。</p><p><code>sortByDesc</code> 方法默认是正序排序，即数值越小排序越靠前。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
