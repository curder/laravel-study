...
<span class="line"><span>$user-&gt;comments()-&gt;delete();</span></span></code></pre></div><h3 id="更新数据" tabindex="-1">更新数据 <a class="header-anchor" href="#更新数据" aria-label="Permalink to &quot;更新数据&quot;">​</a></h3>`,54),t=[l];function i(c,o,d,r,m,g){return a(),n("div",null,t)}const b=s(e,[["render",i]]);export{u as __pageData,b as default};
