import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e8ee2c8f.js";const q=JSON.parse('{"title":"groupBy","description":"","frontmatter":{},"headers":[],"relativePath":"collections/groupBy.md","filePath":"collections/groupBy.md","lastUpdated":1616865921000}'),p={name:"collections/groupBy.md"},o=l(`<h1 id="groupby" tabindex="-1">groupBy <a class="header-anchor" href="#groupby" aria-label="Permalink to &quot;groupBy&quot;">​</a></h1><p><strong>不改变原集合</strong>，根据给定的键对集合内的项目进行分组。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
