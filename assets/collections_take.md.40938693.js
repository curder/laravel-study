import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e8ee2c8f.js";const B=JSON.parse('{"title":"take","description":"","frontmatter":{},"headers":[],"relativePath":"collections/take.md","filePath":"collections/take.md","lastUpdated":1648089437000}'),p={name:"collections/take.md"},o=l(`<h1 id="take" tabindex="-1">take <a class="header-anchor" href="#take" aria-label="Permalink to &quot;take&quot;">​</a></h1><p><strong>不改变原集合</strong>，返回给定数量项目的新集合。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 当传递给定数量的值时，获取到新集合为给定数量的内容。</span></span>
