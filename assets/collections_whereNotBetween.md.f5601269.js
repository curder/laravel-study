import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.5499cfac.js";const B=JSON.parse('{"title":"whereNotBetween","description":"","frontmatter":{},"headers":[],"relativePath":"collections/whereNotBetween.md","filePath":"collections/whereNotBetween.md","lastUpdated":1648089437000}'),p={name:"collections/whereNotBetween.md"},o=l(`<h1 id="wherenotbetween" tabindex="-1">whereNotBetween <a class="header-anchor" href="#wherenotbetween" aria-label="Permalink to &quot;whereNotBetween&quot;">​</a></h1><p>通过确定指定的项目值是否在给定范围内来过滤集合。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">$collection </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
