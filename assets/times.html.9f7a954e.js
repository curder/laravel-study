import{e as n}from"./app.ec5e6153.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="times" tabindex="-1"><a class="header-anchor" href="#times" aria-hidden="true">#</a> times</h1><p><code>times</code> \u65B9\u6CD5\u662F Collection \u7C7B\u7684\u9759\u6001\u65B9\u6CD5\uFF0C\u901A\u8FC7 <code>Collection::times()</code> \u8C03\u7528</p><p>\u901A\u8FC7\u56DE\u8C03\u5728\u7ED9\u5B9A\u6B21\u6570\u5185\u521B\u5EFA\u4E00\u4E2A\u65B0\u96C6\u5408\u3002</p><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token keyword">use</span> <span class="token package">Illuminate<span class="token punctuation">\\</span>Support<span class="token punctuation">\\</span>Collection</span><span class="token punctuation">;</span>
