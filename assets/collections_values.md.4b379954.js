import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.5499cfac.js";const D=JSON.parse('{"title":"values","description":"","frontmatter":{},"headers":[],"relativePath":"collections/values.md","filePath":"collections/values.md","lastUpdated":1616999641000}'),p={name:"collections/values.md"},o=l(`<h1 id="values" tabindex="-1">values <a class="header-anchor" href="#values" aria-label="Permalink to &quot;values&quot;">​</a></h1><p>返回键被重置为连续编号的新集合。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
