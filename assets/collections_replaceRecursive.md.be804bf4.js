import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.16715cb7.js";const h=JSON.parse('{"title":"replaceRecursive","description":"","frontmatter":{},"headers":[],"relativePath":"collections/replaceRecursive.md","filePath":"collections/replaceRecursive.md","lastUpdated":1696669217000}'),p={name:"collections/replaceRecursive.md"},e=l(`<h1 id="replacerecursive" tabindex="-1">replaceRecursive <a class="header-anchor" href="#replacerecursive" aria-label="Permalink to &quot;replaceRecursive&quot;">​</a></h1><p>此方法的工作方式类似于<a href="./replace.html"><code>replace</code></a>，但它将递归到数组中并且对内部的值应用相同的替换。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
