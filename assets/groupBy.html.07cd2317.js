import{e as n}from"./app.f24d8ee0.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="groupby" tabindex="-1"><a class="header-anchor" href="#groupby" aria-hidden="true">#</a> groupBy</h1><p><strong>\u4E0D\u6539\u53D8\u539F\u96C6\u5408</strong>\uFF0C\u6839\u636E\u7ED9\u5B9A\u7684\u952E\u5BF9\u96C6\u5408\u5185\u7684\u9879\u76EE\u8FDB\u884C\u5206\u7EC4\u3002</p><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token function">collect</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
