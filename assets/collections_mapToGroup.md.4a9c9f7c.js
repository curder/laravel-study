import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aefb929a.js";const B=JSON.parse('{"title":"mapToGroup","description":"","frontmatter":{},"headers":[],"relativePath":"collections/mapToGroup.md","filePath":"collections/mapToGroup.md","lastUpdated":1616865921000}'),p={name:"collections/mapToGroup.md"},o=l(`<h1 id="maptogroup" tabindex="-1">mapToGroup <a class="header-anchor" href="#maptogroup" aria-label="Permalink to &quot;mapToGroup&quot;">​</a></h1><p>该闭包应返回一个包含单个键/值对的关联数组，从而形成一个新的分组值集合</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
