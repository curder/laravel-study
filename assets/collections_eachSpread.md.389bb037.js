import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.5499cfac.js";const q=JSON.parse('{"title":"eachSpread","description":"","frontmatter":{},"headers":[],"relativePath":"collections/eachSpread.md","filePath":"collections/eachSpread.md","lastUpdated":1648089437000}'),o={name:"collections/eachSpread.md"},p=l(`<h1 id="eachspread" tabindex="-1">eachSpread <a class="header-anchor" href="#eachspread" aria-label="Permalink to &quot;eachSpread&quot;">​</a></h1><p>迭代集合中的内容，<strong>不改变原集合</strong>的同时将其传递到回调函数中，通常用于二维数组的循环，在回调函数中给值命名。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
