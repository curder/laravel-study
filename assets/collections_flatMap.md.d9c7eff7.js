import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.5499cfac.js";const f=JSON.parse('{"title":"flatMap","description":"","frontmatter":{},"headers":[],"relativePath":"collections/flatMap.md","filePath":"collections/flatMap.md","lastUpdated":1616865921000}'),p={name:"collections/flatMap.md"},o=l(`<h1 id="flatmap" tabindex="-1">flatMap <a class="header-anchor" href="#flatmap" aria-label="Permalink to &quot;flatMap&quot;">​</a></h1><p>遍历集合并将其中的每个值传递到给定的回调，可以通过回调修改每个值的内容再返回出来，从而形成一个新的被修改过内容的集合。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
