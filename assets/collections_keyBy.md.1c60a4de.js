import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.aefb929a.js";const F=JSON.parse('{"title":"keyBy","description":"","frontmatter":{},"headers":[],"relativePath":"collections/keyBy.md","filePath":"collections/keyBy.md","lastUpdated":1616865921000}'),p={name:"collections/keyBy.md"},o=l(`<h1 id="keyby" tabindex="-1">keyBy <a class="header-anchor" href="#keyby" aria-label="Permalink to &quot;keyBy&quot;">​</a></h1><p>以给定的键作为集合的键。如果多个项目具有相同的键，则只有最后一个项目会显示在新集合中。</p><div class="language-php vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">collect</span><span style="color:#E1E4E8;">([</span></span>
