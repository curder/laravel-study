import{_ as s,o as n,c as a,O as l}from"./chunks/framework.5035f75f.js";const u=JSON.parse('{"title":"times","description":"","frontmatter":{},"headers":[],"relativePath":"collections/times.md","filePath":"collections/times.md","lastUpdated":1616865921000}'),t={name:"collections/times.md"},o=l(`<h1 id="times" tabindex="-1">times <a class="header-anchor" href="#times" aria-label="Permalink to &quot;times&quot;">​</a></h1><p><code>times</code> 方法是 Collection 类的静态方法，通过 <code>Collection::times()</code> 调用</p><p>通过回调在给定次数内创建一个新集合。</p><div class="language-php"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#F78C6C;">use</span><span style="color:#FFCB6B;"> </span><span style="color:#A6ACCD;">Illuminate</span><span style="color:#89DDFF;">\\</span><span style="color:#A6ACCD;">Support</span><span style="color:#89DDFF;">\\</span><span style="color:#A6ACCD;">Collection</span><span style="color:#89DDFF;">;</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;"> ],</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">}</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">*/</span></span></code></pre></div><p>使用这个方法可以与工厂结合使用创建出 <code>Eloquent</code> 模型</p><div class="language-php"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#F78C6C;">use</span><span style="color:#FFCB6B;"> </span><span style="color:#A6ACCD;">App</span><span style="color:#89DDFF;">\\</span><span style="color:#A6ACCD;">Models</span><span style="color:#89DDFF;">\\</span><span style="color:#A6ACCD;">User</span><span style="color:#89DDFF;">;</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;"> ],</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">] </span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">*/</span></span></code></pre></div>`,6),p=[o];function e(c,i,y,r,D,A){return n(),a("div",null,p)}const C=s(t,[["render",e]]);export{u as __pageData,C as default};
