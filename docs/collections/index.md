...
| [chunk](chuck.md)                       | 将集合拆成多个指定大小的小集合                                                                   |
...
| [containsOneItem](containsOneItem.md)   | TODO                                                                              |
| [containsStrict](containsStrict.md)     | 使用「严格模式」来比较所有值                                                                    |
| [count](count.md)                       | 返回该集合内的项目总数                                                                       |
| [countBy](countBy.md)                   | TODO                                                                              | 
...
| [filter](filter.md)                     | 使用给定的回调函数过滤集合的内容，只留下那些通过给定真实测试的内容                                                 |
| [first](first.md)                       | 返回集合中通过给定真实测试的第一个元素                                                               |
