...
![](/tests/unit-test-laravel-api-pest-framework/init-run-pest-test-pass.jpg "Run pest test passed")
...
![](/tests/unit-test-laravel-api-pest-framework/run-pest-test-failed.jpg)
...
![](/tests/unit-test-laravel-api-pest-framework/run-pest-test-pass.jpg)
